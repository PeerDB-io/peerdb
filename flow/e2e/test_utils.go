...
func GetOwnersSchema() *qvalue.QRecordSchema {
	return &qvalue.QRecordSchema{
		Fields: []qvalue.QField{
			{Name: "id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "card_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "from", Type: qvalue.QType{Kind: qvalue.QKindTimestamp}, Nullable: true},
			{Name: "price", Type: qvalue.QType{Kind: qvalue.QKindNumeric}, Nullable: true},
			{Name: "created_at", Type: qvalue.QType{Kind: qvalue.QKindTimestamp}, Nullable: true},
			{Name: "updated_at", Type: qvalue.QType{Kind: qvalue.QKindTimestamp}, Nullable: true},
			{Name: "transaction_hash", Type: qvalue.QType{Kind: qvalue.QKindBytes}, Nullable: true},
			{Name: "ownerable_type", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "ownerable_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "user_nonce", Type: qvalue.QType{Kind: qvalue.QKindInt64}, Nullable: true},
			{Name: "transfer_type", Type: qvalue.QType{Kind: qvalue.QKindInt64}, Nullable: true},
			{Name: "blockchain", Type: qvalue.QType{Kind: qvalue.QKindInt64}, Nullable: true},
			{Name: "deal_type", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "deal_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "ethereum_transaction_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "ignore_price", Type: qvalue.QType{Kind: qvalue.QKindBoolean}, Nullable: true},
			{Name: "card_eth_value", Type: qvalue.QType{Kind: qvalue.QKindFloat64}, Nullable: true},
			{Name: "paid_eth_price", Type: qvalue.QType{Kind: qvalue.QKindFloat64}, Nullable: true},
			{Name: "card_bought_notified", Type: qvalue.QType{Kind: qvalue.QKindBoolean}, Nullable: true},
			{Name: "address", Type: qvalue.QType{Kind: qvalue.QKindNumeric}, Nullable: true},
			{Name: "account_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "asset_id", Type: qvalue.QType{Kind: qvalue.QKindNumeric}, Nullable: true},
			{Name: "status", Type: qvalue.QType{Kind: qvalue.QKindInt64}, Nullable: true},
			{Name: "transaction_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "settled_at", Type: qvalue.QType{Kind: qvalue.QKindTimestamp}, Nullable: true},
			{Name: "reference_id", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "settle_at", Type: qvalue.QType{Kind: qvalue.QKindTimestamp}, Nullable: true},
			{Name: "settlement_delay_reason", Type: qvalue.QType{Kind: qvalue.QKindInt64}, Nullable: true},
			{Name: "f1", Type: qvalue.QType{Kind: qvalue.QKindArray, Array: &qvalue.QType{Kind: qvalue.QKindString}}, Nullable: true},
			{Name: "f2", Type: qvalue.QType{Kind: qvalue.QKindArray, Array: &qvalue.QType{Kind: qvalue.QKindInt64}}, Nullable: true},
			{Name: "f3", Type: qvalue.QType{Kind: qvalue.QKindArray, Array: &qvalue.QType{Kind: qvalue.QKindInt32}}, Nullable: true},
			{Name: "f4", Type: qvalue.QType{Kind: qvalue.QKindArray, Array: &qvalue.QType{Kind: qvalue.QKindString}}, Nullable: true},
			{Name: "f5", Type: qvalue.QType{Kind: qvalue.QKindJSON}, Nullable: true},
			{Name: "f6", Type: qvalue.QType{Kind: qvalue.QKindJSON}, Nullable: true},
			{Name: "f7", Type: qvalue.QType{Kind: qvalue.QKindJSON}, Nullable: true},
			{Name: "f8", Type: qvalue.QType{Kind: qvalue.QKindInt16}, Nullable: true},
			{Name: "f13", Type: qvalue.QType{Kind: qvalue.QKindArray, Array: &qvalue.QType{Kind: qvalue.QKindInt16}}, Nullable: true},
			{Name: "my_date", Type: qvalue.QType{Kind: qvalue.QKindDate}, Nullable: true},
			{Name: "old_date", Type: qvalue.QType{Kind: qvalue.QKindDate}, Nullable: true},
			{Name: "my_time", Type: qvalue.QType{Kind: qvalue.QKindTime}, Nullable: true},
			{Name: "my_mood", Type: qvalue.QType{Kind: qvalue.QKindString}, Nullable: true},
			{Name: "geometryPoint", Type: qvalue.QType{Kind: qvalue.QKindGeometry}, Nullable: true},
			{Name: "geometry_linestring", Type: qvalue.QType{Kind: qvalue.QKindGeometry}, Nullable: true},
			{Name: "geometry_polygon", Type: qvalue.QType{Kind: qvalue.QKindGeometry}, Nullable: true},
			{Name: "geography_point", Type: qvalue.QType{Kind: qvalue.QKindGeography}, Nullable: true},
			{Name: "geography_linestring", Type: qvalue.QType{Kind: qvalue.QKindGeography}, Nullable: true},
			{Name: "geography_polygon", Type: qvalue.QType{Kind: qvalue.QKindGeography}, Nullable: true},
			{Name: "myreal", Type: qvalue.QType{Kind: qvalue.QKindFloat32}, Nullable: true},
			{Name: "myreal2", Type: qvalue.QType{Kind: qvalue.QKindFloat32}, Nullable: true},
			{Name: "myreal3", Type: qvalue.QType{Kind: qvalue.QKindFloat32}, Nullable: true},
		},
	}
}
