...
func (s opensearchSuite) Test_Simple_PKey_CDC_Mirror() {
	srcTableName := e2e.AttachSchema(s, "os_simple_pkey_cdc")
	...
	connectionGen := e2e.FlowConnectionGenerationConfig{
		FlowJobName:      e2e.AddSuffix(s, "os_simple_pkey_cdc"),
...
func (s opensearchSuite) Test_Composite_PKey_CDC_Mirror() {
	srcTableName := e2e.AttachSchema(s, "os_composite_pkey_cdc")
