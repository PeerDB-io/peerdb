...
var file_flow_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_flow_proto_goTypes = []interface{}{
	...
	(*GetTableSchemaBatchInput)(nil),        // 19: peerdb_flow.GetTableSchemaBatchInput
	(*GetTableSchemaBatchOutput)(nil),       // 20: peerdb_flow.GetTableSchemaBatchOutput
	(*SetupNormalizedTableInput)(nil),       // 21: peerdb_flow.SetupNormalizedTableInput
	(*SetupNormalizedTableBatchInput)(nil),  // 22: peerdb_flow.SetupNormalizedTableBatchInput
	(*SetupNormalizedTableOutput)(nil),      // 23: peerdb_flow.SetupNormalizedTableOutput
	(*SetupNormalizedTableBatchOutput)(nil), // 24: peerdb_flow.SetupNormalizedTableBatchOutput
	(*IntPartitionRange)(nil),               // 25: peerdb_flow.IntPartitionRange
	(*TimestampPartitionRange)(nil),         // 26: peerdb_flow.TimestampPartitionRange
	(*TID)(nil),                             // 27: peerdb_flow.TID
	(*TIDPartitionRange)(nil),               // 28: peerdb_flow.TIDPartitionRange
	(*PartitionRange)(nil),                  // 29: peerdb_flow.PartitionRange
	(*QRepWriteMode)(nil),                   // 30: peerdb_flow.QRepWriteMode
	(*QRepConfig)(nil),                      // 31: peerdb_flow.QRepConfig
	(*QRepPartition)(nil),                   // 32: peerdb_flow.QRepPartition
	(*QRepParitionResult)(nil),              // 33: peerdb_flow.QRepParitionResult
	(*DropFlowInput)(nil),                   // 34: peerdb_flow.DropFlowInput
	nil,                                     // 35: peerdb_flow.FlowConnectionConfigs.TableNameMappingEntry
	nil,                                     // 36: peerdb_flow.FlowConnectionConfigs.SrcTableIdNameMappingEntry
	nil,                                     // 37: peerdb_flow.FlowConnectionConfigs.TableNameSchemaMappingEntry
	nil,                                     // 38: peerdb_flow.SetupReplicationInput.TableNameMappingEntry
	nil,                                     // 39: peerdb_flow.CreateRawTableInput.TableNameMappingEntry
	nil,                                     // 40: peerdb_flow.TableSchema.ColumnsEntry
	nil,                                     // 41: peerdb_flow.GetTableSchemaBatchOutput.TableNameSchemaMappingEntry
	nil,                                     // 42: peerdb_flow.SetupNormalizedTableBatchInput.TableNameSchemaMappingEntry
	nil,                                     // 43: peerdb_flow.SetupNormalizedTableBatchOutput.TableExistsMappingEntry
	(*Peer)(nil),                            // 44: peerdb_peers.Peer
	(*timestamppb.Timestamp)(nil),           // 45: google.protobuf.Timestamp
}
var file_flow_proto_depIdxs = []int32{
	44, // 0: peerdb_flow.FlowConnectionConfigs.source:type_name -> peerdb_peers.Peer
	44, // 1: peerdb_flow.FlowConnectionConfigs.destination:type_name -> peerdb_peers.Peer
	18, // 2: peerdb_flow.FlowConnectionConfigs.table_schema:type_name -> peerdb_flow.TableSchema
	35, // 3: peerdb_flow.FlowConnectionConfigs.table_name_mapping:type_name -> peerdb_flow.FlowConnectionConfigs.TableNameMappingEntry
	36, // 4: peerdb_flow.FlowConnectionConfigs.src_table_id_name_mapping:type_name -> peerdb_flow.FlowConnectionConfigs.SrcTableIdNameMappingEntry
	37, // 5: peerdb_flow.FlowConnectionConfigs.table_name_schema_mapping:type_name -> peerdb_flow.FlowConnectionConfigs.TableNameSchemaMappingEntry
	44, // 6: peerdb_flow.FlowConnectionConfigs.metadata_peer:type_name -> peerdb_peers.Peer
	0,  // 7: peerdb_flow.FlowConnectionConfigs.snapshot_sync_mode:type_name -> peerdb_flow.QRepSyncMode
	45, // 8: peerdb_flow.LastSyncState.last_synced_at:type_name -> google.protobuf.Timestamp
	...
	44, // 13: peerdb_flow.GetLastSyncedIDInput.peer_connection_config:type_name -> peerdb_peers.Peer
	44, // 14: peerdb_flow.EnsurePullabilityInput.peer_connection_config:type_name -> peerdb_peers.Peer
	...
	44, // 17: peerdb_flow.SetupReplicationInput.peer_connection_config:type_name -> peerdb_peers.Peer
	38, // 18: peerdb_flow.SetupReplicationInput.table_name_mapping:type_name -> peerdb_flow.SetupReplicationInput.TableNameMappingEntry
	44, // 19: peerdb_flow.SetupReplicationInput.destination_peer:type_name -> peerdb_peers.Peer
	44, // 20: peerdb_flow.CreateRawTableInput.peer_connection_config:type_name -> peerdb_peers.Peer
	39, // 21: peerdb_flow.CreateRawTableInput.table_name_mapping:type_name -> peerdb_flow.CreateRawTableInput.TableNameMappingEntry
	40, // 22: peerdb_flow.TableSchema.columns:type_name -> peerdb_flow.TableSchema.ColumnsEntry
	44, // 23: peerdb_flow.GetTableSchemaBatchInput.peer_connection_config:type_name -> peerdb_peers.Peer
	41, // 24: peerdb_flow.GetTableSchemaBatchOutput.table_name_schema_mapping:type_name -> peerdb_flow.GetTableSchemaBatchOutput.TableNameSchemaMappingEntry
	44, // 25: peerdb_flow.SetupNormalizedTableInput.peer_connection_config:type_name -> peerdb_peers.Peer
	18, // 26: peerdb_flow.SetupNormalizedTableInput.source_table_schema:type_name -> peerdb_flow.TableSchema
	44, // 27: peerdb_flow.SetupNormalizedTableBatchInput.peer_connection_config:type_name -> peerdb_peers.Peer
	42, // 28: peerdb_flow.SetupNormalizedTableBatchInput.table_name_schema_mapping:type_name -> peerdb_flow.SetupNormalizedTableBatchInput.TableNameSchemaMappingEntry
	43, // 29: peerdb_flow.SetupNormalizedTableBatchOutput.table_exists_mapping:type_name -> peerdb_flow.SetupNormalizedTableBatchOutput.TableExistsMappingEntry
	45, // 30: peerdb_flow.TimestampPartitionRange.start:type_name -> google.protobuf.Timestamp
	45, // 31: peerdb_flow.TimestampPartitionRange.end:type_name -> google.protobuf.Timestamp
	27, // 32: peerdb_flow.TIDPartitionRange.start:type_name -> peerdb_flow.TID
	27, // 33: peerdb_flow.TIDPartitionRange.end:type_name -> peerdb_flow.TID
	25, // 34: peerdb_flow.PartitionRange.int_range:type_name -> peerdb_flow.IntPartitionRange
	26, // 35: peerdb_flow.PartitionRange.timestamp_range:type_name -> peerdb_flow.TimestampPartitionRange
	28, // 36: peerdb_flow.PartitionRange.tid_range:type_name -> peerdb_flow.TIDPartitionRange
	1,  // 37: peerdb_flow.QRepWriteMode.write_type:type_name -> peerdb_flow.QRepWriteType
	44, // 38: peerdb_flow.QRepConfig.source_peer:type_name -> peerdb_peers.Peer
	44, // 39: peerdb_flow.QRepConfig.destination_peer:type_name -> peerdb_peers.Peer
	0,  // 40: peerdb_flow.QRepConfig.sync_mode:type_name -> peerdb_flow.QRepSyncMode
	30, // 41: peerdb_flow.QRepConfig.write_mode:type_name -> peerdb_flow.QRepWriteMode
	29, // 42: peerdb_flow.QRepPartition.range:type_name -> peerdb_flow.PartitionRange
	32, // 43: peerdb_flow.QRepParitionResult.partitions:type_name -> peerdb_flow.QRepPartition
	18, // 44: peerdb_flow.FlowConnectionConfigs.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
	18, // 45: peerdb_flow.GetTableSchemaBatchOutput.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
	18, // 46: peerdb_flow.SetupNormalizedTableBatchInput.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
...
func file_flow_proto_init() {
	...
	file_flow_proto_msgTypes[27].OneofWrappers = []interface{}{
