...
var file_flow_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x99, 0x03,
	...
	0x43, 0x6f, 0x70, 0x79, 0x1a, 0x43, 0x0a, 0x15, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d,
	...
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xae, 0x02, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x67, 0x1a, 0x43, 0x0a, 0x15, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x4d, 0x61,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0xe3, 0x01, 0x0a, 0x0b, 0x54, 0x61,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79,
	0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x10, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x43, 0x6f, 0x6c,
	0x75, 0x6d, 0x6e, 0x1a, 0x3a, 0x0a, 0x0c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
...
var file_flow_proto_depIdxs = []int32{
	...
	48, // 8: peerdb_flow.LastSyncState.last_synced_at:type_name -> google.protobuf.Timestamp
	...
	47, // 13: peerdb_flow.GetLastSyncedIDInput.peer_connection_config:type_name -> peerdb_peers.Peer
	47, // 14: peerdb_flow.EnsurePullabilityInput.peer_connection_config:type_name -> peerdb_peers.Peer
	47, // 15: peerdb_flow.EnsurePullabilityBatchInput.peer_connection_config:type_name -> peerdb_peers.Peer
	12, // 16: peerdb_flow.TableIdentifier.postgres_table_identifier:type_name -> peerdb_flow.PostgresTableIdentifier
	13, // 17: peerdb_flow.EnsurePullabilityOutput.table_identifier:type_name -> peerdb_flow.TableIdentifier
	40, // 18: peerdb_flow.EnsurePullabilityBatchOutput.table_identifier_mapping:type_name -> peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry
	47, // 19: peerdb_flow.SetupReplicationInput.peer_connection_config:type_name -> peerdb_peers.Peer
	41, // 20: peerdb_flow.SetupReplicationInput.table_name_mapping:type_name -> peerdb_flow.SetupReplicationInput.TableNameMappingEntry
	47, // 21: peerdb_flow.SetupReplicationInput.destination_peer:type_name -> peerdb_peers.Peer
	47, // 22: peerdb_flow.CreateRawTableInput.peer_connection_config:type_name -> peerdb_peers.Peer
	42, // 23: peerdb_flow.CreateRawTableInput.table_name_mapping:type_name -> peerdb_flow.CreateRawTableInput.TableNameMappingEntry
	43, // 24: peerdb_flow.TableSchema.columns:type_name -> peerdb_flow.TableSchema.ColumnsEntry
	47, // 25: peerdb_flow.GetTableSchemaBatchInput.peer_connection_config:type_name -> peerdb_peers.Peer
	44, // 26: peerdb_flow.GetTableSchemaBatchOutput.table_name_schema_mapping:type_name -> peerdb_flow.GetTableSchemaBatchOutput.TableNameSchemaMappingEntry
	47, // 27: peerdb_flow.SetupNormalizedTableInput.peer_connection_config:type_name -> peerdb_peers.Peer
	20, // 28: peerdb_flow.SetupNormalizedTableInput.source_table_schema:type_name -> peerdb_flow.TableSchema
	47, // 29: peerdb_flow.SetupNormalizedTableBatchInput.peer_connection_config:type_name -> peerdb_peers.Peer
	45, // 30: peerdb_flow.SetupNormalizedTableBatchInput.table_name_schema_mapping:type_name -> peerdb_flow.SetupNormalizedTableBatchInput.TableNameSchemaMappingEntry
	46, // 31: peerdb_flow.SetupNormalizedTableBatchOutput.table_exists_mapping:type_name -> peerdb_flow.SetupNormalizedTableBatchOutput.TableExistsMappingEntry
	48, // 32: peerdb_flow.TimestampPartitionRange.start:type_name -> google.protobuf.Timestamp
	48, // 33: peerdb_flow.TimestampPartitionRange.end:type_name -> google.protobuf.Timestamp
	29, // 34: peerdb_flow.TIDPartitionRange.start:type_name -> peerdb_flow.TID
	29, // 35: peerdb_flow.TIDPartitionRange.end:type_name -> peerdb_flow.TID
	27, // 36: peerdb_flow.PartitionRange.int_range:type_name -> peerdb_flow.IntPartitionRange
	28, // 37: peerdb_flow.PartitionRange.timestamp_range:type_name -> peerdb_flow.TimestampPartitionRange
	30, // 38: peerdb_flow.PartitionRange.tid_range:type_name -> peerdb_flow.TIDPartitionRange
	1,  // 39: peerdb_flow.QRepWriteMode.write_type:type_name -> peerdb_flow.QRepWriteType
	47, // 40: peerdb_flow.QRepConfig.source_peer:type_name -> peerdb_peers.Peer
	47, // 41: peerdb_flow.QRepConfig.destination_peer:type_name -> peerdb_peers.Peer
	0,  // 42: peerdb_flow.QRepConfig.sync_mode:type_name -> peerdb_flow.QRepSyncMode
	32, // 43: peerdb_flow.QRepConfig.write_mode:type_name -> peerdb_flow.QRepWriteMode
	31, // 44: peerdb_flow.QRepPartition.range:type_name -> peerdb_flow.PartitionRange
	34, // 45: peerdb_flow.QRepParitionResult.partitions:type_name -> peerdb_flow.QRepPartition
	20, // 46: peerdb_flow.FlowConnectionConfigs.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
	13, // 47: peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry.value:type_name -> peerdb_flow.TableIdentifier
	20, // 48: peerdb_flow.GetTableSchemaBatchOutput.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
	20, // 49: peerdb_flow.SetupNormalizedTableBatchInput.TableNameSchemaMappingEntry.value:type_name -> peerdb_flow.TableSchema
