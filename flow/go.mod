...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20250929121537-3baa4e85da0f
	...
	k8s.io/client-go v0.34.1 // Note: v0.* are newer than v1.*
)
...
require (
	...
	github.com/PeerDB-io/peerdb/flow/shared-validation v0.0.0
	...
	github.com/pingcap/kvproto v0.0.0-20250928021345-732fa68a7b72 // indirect
	...
	github.com/tikv/pd/client v0.0.0-20250929031858-50a938a71096 // indirect
...
replace github.com/PeerDB-io/peerdb/flow/shared-validation => ./shared-validation
