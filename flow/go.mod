...
require (
	...
	github.com/go-mysql-org/go-mysql v1.14.1-0.20260428073253-961379bc91ca
	...
	google.golang.org/api v0.274.0 // PINNED(DBI-443): v0.258.0 deprecates WithCredentialsJSON, migrate to WithAuthCredentialsJSON
