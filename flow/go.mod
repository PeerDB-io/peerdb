...
require (
	...
	cloud.google.com/go/pubsub/v2 v2.5.0 // PINNED: v2.4.0+ requires google.golang.org/api v0.259.0
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.22.10 // PINNED(DBI-500): v1.22.0 deprecates NewUploader in favor of feature/s3/transfermanager
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260327114417-11d9c77c35ff
	...
	google.golang.org/api v0.273.0 // PINNED(DBI-443): v0.258.0 deprecates WithCredentialsJSON, migrate to WithAuthCredentialsJSON
...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20260326084500-678ff92b1edd // indirect
	...
	github.com/tikv/pd/client v0.0.0-20260327063000-99eb5b50cf1e // indirect
