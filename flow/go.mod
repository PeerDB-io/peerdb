...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260420161007-7f3e45f930e1
	...
	k8s.io/client-go v0.35.4 // Note: v0.* are newer than v1.*
)
...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20260420081727-18a097f7dd02 // indirect
	...
	github.com/tikv/pd/client v0.0.0-20260416025603-e430bd0966dd // indirect
