...
func TestDDLTypesIntegers(t *testing.T) {
	ddlTypesRun(t, []ddlTypeCase{
		...
		{typ: "TINYINT(1) UNSIGNED", want: ddlTypesCol("tinyint unsigned", -1, -1, false)},
		{typ: "TINYINT(01) UNSIGNED", want: ddlTypesCol("tinyint unsigned", -1, -1, false)},
		{typ: "TINYINT(1) UNSIGNED", want: ddlTypesCol("tinyint(1) unsigned", 1, -1, false), maria: true},
		{typ: "TINYINT(1) ZEROFILL", want: ddlTypesCol("tinyint unsigned zerofill", -1, -1, false)},
		{typ: "TINYINT(1) ZEROFILL", want: ddlTypesCol("tinyint(1) unsigned zerofill", 1, -1, false), maria: true},
		...
		{typ: "INT ZEROFILL", want: ddlTypesCol("int unsigned zerofill", -1, -1, false)},
		{typ: "INT UNSIGNED ZEROFILL", want: ddlTypesCol("int unsigned zerofill", -1, -1, false)},
		{typ: "INT(10) ZEROFILL UNSIGNED", want: ddlTypesCol("int(10) unsigned zerofill", 10, -1, false)},
...
func TestDDLTypesAttributeSkipping(t *testing.T) {
	ddlTypesRun(t, []ddlTypeCase{
		...
		{typ: "INT AUTO_INCREMENT", want: ddlTypesCol("int", -1, -1, true)},
		{typ: "INT PRIMARY KEY", want: ddlTypesCol("int", -1, -1, true)},
		{typ: "INT KEY", want: ddlTypesCol("int", -1, -1, true)},
		{typ: "INT UNIQUE KEY", want: ddlTypesCol("int", -1, -1, false)},
