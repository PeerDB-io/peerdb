...
func TestSSHTunnel_Watch_NilCases(t *testing.T) {
	// Nil tunnel
	var tunnel *SSHTunnel = nil
	require.Nil(t, tunnel.Watch(), "Nil tunnel should return nil channel")

	// Nil client
	tunnel = &SSHTunnel{Client: nil}
	require.Nil(t, tunnel.Watch(), "Tunnel with nil client should return nil channel")
}
