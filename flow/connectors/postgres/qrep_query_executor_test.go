...
func TestStringDataTypes(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			ArrayExpected: []string{"12:30:45+05", "18:15:30-08", "NULL"}, // outlier
		},
		{
			Type:          "interval",
		...
		},
		{
			...
			ArrayLiteral:  `'{"[2023-01-01 00:00:00-02,2023-12-31 23:59:59+00]", "[2024-01-01 00:00:00-02,2024-12-31 23:59:59+00]", NULL}'::tstzrange[]`,
		...
		},
		{
			...
			ArrayExpected: []string{"{[1,11),[20,31)}", "{[100,111),[120,131)}", "NULL"}, // outlier
		},
		{
			Type:          "int4multirange",
		...
		},
		{
			...
			ArrayLiteral: `'{"{[1,10000000000],[20000000000,30000000000]}", "{[40000000000,50000000000],[60000000000,70000000000]}", NULL}'::int8multirange[]`,
			ArrayExpected: []string{
		...
		},
		{
			...
			ArrayLiteral: `'{"{[1.1,10.9],[20.1,30.9]}", "{[100.1,110.9],[120.1,130.9]}", NULL}'::nummultirange[]`,
			ArrayExpected: []string{
				"{[1.1,10.9],[20.1,30.9]}",
		...
		},
		{
			...
			ArrayLiteral: `'{"{[2023-01-01 00:00:00,2023-01-31 23:59:59],[2023-03-01 00:00:00,2023-03-31 23:59:59]}","{[2024-01-01 00:00:00,2024-01-31 23:59:59],[2024-03-01 00:00:00,2024-03-31 23:59:59]}", NULL}'::tsmultirange[]`,
			ArrayExpected: []string{
		...
		},
		{
			...
			ArrayLiteral:  `'{"{(,2023-01-31 23:59:59],[2023-03-01 00:00:00,)}","{(,2024-01-31 23:59:59],[2024-03-01 00:00:00,)}"}'::tsmultirange[]`,
			ArrayExpected: []string{"{(,\"2023-01-31 23:59:59\"],[\"2023-03-01 00:00:00\",)}", "{(,\"2024-01-31 23:59:59\"],[\"2024-03-01 00:00:00\",)}"},
		},
		{
			Type:         "tstzmultirange",
			...
			ArrayLiteral: `'{"{[2023-01-01 00:00:00-02,2023-01-31 23:59:59+00],[2023-03-01 00:00:00-02,2023-03-31 23:59:59+00]}","{[2024-01-01 00:00:00-02,2024-01-31 23:59:59+00],[2024-03-01 00:00:00-02,2024-03-31 23:59:59+00]}", NULL}'::tstzmultirange[]`,
			ArrayExpected: []string{
		...
		},
		{
			...
			ArrayLiteral:  `'{"{(,2023-01-31 23:59:59+00],[2023-03-01 00:00:00-02,)}","{(,2024-01-31 23:59:59+00],[2024-03-01 00:00:00-02,)}"}'::tstzmultirange[]`,
			ArrayExpected: []string{"{(,\"2023-01-31 23:59:59+00\"],[\"2023-03-01 02:00:00+00\",)}", "{(,\"2024-01-31 23:59:59+00\"],[\"2024-03-01 02:00:00+00\",)}"},
		},
		{
			Type:         "datemultirange",
			Literal:      "'{[2023-01-01,2023-01-31],[2023-03-01,2023-03-31]}'::datemultirange",
			Expected:     "{[2023-01-01,2023-02-01),[2023-03-01,2023-04-01)}",
			ArrayLiteral: `'{"{[2023-01-01,2023-01-31],[2023-03-01,2023-03-31]}","{[2024-01-01,2024-01-31],[2024-03-01,2024-03-31]}", NULL}'::datemultirange[]`,
			ArrayExpected: []string{
