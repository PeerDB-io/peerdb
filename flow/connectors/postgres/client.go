...
const (
	...
	INSERT (%s) OVERRIDING SYSTEM VALUE VALUES (%s) %s
	...
	INSERT INTO %s (%s) OVERRIDING SYSTEM VALUE SELECT %s FROM src_rank WHERE _peerdb_rank=1 AND _peerdb_record_type!=2
