...
func TestStructuredQValuesFromBsonRaw(t *testing.T) {
	...
	toRecord := func(t *testing.T, doc bson.D) []types.QValue {
		...
		require.NoError(t, err)
		record, err := StructuredQValuesFromBsonRaw(raw, shared.InternalVersion_Latest, converter, NewStructuredProjection(projector), "db.coll")
		require.NoError(t, err)
	...
	t.Run("missing id", func(t *testing.T) {
		...
		require.NoError(t, err)
		_, err = StructuredQValuesFromBsonRaw(raw, shared.InternalVersion_Latest, converter, NewStructuredProjection(projector), "db.coll")
		require.Error(t, err)
	})
}
...
func TestStructuredArrayColumns(t *testing.T) {
	...
	t.Run("fitting arrays land typed", func(t *testing.T) {
		...
		require.NoError(t, err)
		record, err := StructuredQValuesFromBsonRaw(raw, shared.InternalVersion_Latest, converter, projection, "db.coll")
		require.NoError(t, err)
