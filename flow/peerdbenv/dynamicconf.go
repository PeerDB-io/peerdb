...
var DynamicSettings = [...]*protos.DynamicSetting{
	...
	{
		Name: "PEERDB_CLICKHOUSE_USE_EXPERIMENTAL_JSON_TYPE",
...
func PeerDBClickHouseUseExperimentalJSONType(ctx context.Context, env map[string]string) (bool, error) {
	return dynamicConfBool(ctx, env, "PEERDB_CLICKHOUSE_USE_EXPERIMENTAL_JSON_TYPE")
}
