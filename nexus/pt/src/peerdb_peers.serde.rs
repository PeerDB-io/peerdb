...
impl serde::Serialize for EventHubGroupConfig {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for EventHubGroupConfig {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = EventHubGroupConfig;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct peerdb_peers.EventHubGroupConfig")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<EventHubGroupConfig, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Eventhubs => {
                            if eventhubs__.is_some() {
                                return Err(serde::de::Error::duplicate_field("eventhubs"));
                            }
                            eventhubs__ = Some(
        ...
        deserializer.deserialize_struct("peerdb_peers.EventHubGroupConfig", FIELDS, GeneratedVisitor)
    }
}
...
;
                        ...
                        GeneratedField::EventhubGroupConfig => {
                            if config__.is_some() {
...
impl serde::Serialize for PostgresConfig {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.ssh_config.as_ref() {
            struct_ser.serialize_field("sshConfig", v)?;
        }
        struct_ser.end()
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "metadataSchema" | "metadata_schema" => Ok(GeneratedField::MetadataSchema),
                            "sshConfig" | "ssh_config" => Ok(GeneratedField::SshConfig),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::SshConfig => {
                            if ssh_config__.is_some() {
                                return Err(serde::de::Error::duplicate_field("sshConfig"));
                            }
                            ssh_config__ = map.next_value()?;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map.next_value::<serde::de::IgnoredAny>()?;
                        }
...
impl serde::Serialize for SshConfig {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("peerdb_peers.SSHConfig", len)?;
        if !self.host.is_empty() {
            struct_ser.serialize_field("host", &self.host)?;
        }
        if self.port != 0 {
...
impl<'de> serde::Deserialize<'de> for SshConfig {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct peerdb_peers.SSHConfig")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SshConfig, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut host__ = None;
        ...
        deserializer.deserialize_struct("peerdb_peers.SSHConfig", FIELDS, GeneratedVisitor)
    }
}
