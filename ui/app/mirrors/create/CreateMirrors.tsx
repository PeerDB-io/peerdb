...
type CreateMirrorsProps = {
  peersPromise: Promise<ListPeersResponse>;
};

export default function CreateMirrors({ peersPromise }: CreateMirrorsProps) {
  const peers = React.use(peersPromise);
