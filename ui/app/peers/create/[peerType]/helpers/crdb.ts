...
export const cockroachdbSetting: PeerSetting[] = [
  ...
  {
    label: 'Enable Changefeeds?',
    stateHandler: (value, setter) =>
      setter((curr) => ({ ...curr, useChangefeeds: value as boolean })),
    type: 'switch',
    optional: true,
    tips: 'Required for CDC mirrors. Uses CockroachDB changefeeds, which need the kv.rangefeed.enabled cluster setting on self-hosted clusters.',
  },
  {
