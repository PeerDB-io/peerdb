...
Register new E2E suites in [flow/test-jobs.yml](flow/test-jobs.yml). That file also
assigns package prefixes to source test jobs; unassigned packages run in the unit job.
