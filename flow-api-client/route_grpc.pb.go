...
type FlowServiceClient interface {
	...
	GetMirrorRowCounts(ctx context.Context, in *RowCountRequest, opts ...grpc.CallOption) (*RowCountResponse, error)
}
...
func (c *flowServiceClient) ValidatePeer(ctx context.Context, in *ValidatePeerRequest, opts ...grpc.CallOption) (*ValidatePeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ValidatePeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) ValidateCDCMirror(ctx context.Context, in *CreateCDCFlowRequest, opts ...grpc.CallOption) (*ValidateCDCMirrorResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ValidateCDCMirror_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CreatePeer(ctx context.Context, in *CreatePeerRequest, opts ...grpc.CallOption) (*CreatePeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_CreatePeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) DropPeer(ctx context.Context, in *DropPeerRequest, opts ...grpc.CallOption) (*DropPeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_DropPeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CreateCDCFlow(ctx context.Context, in *CreateCDCFlowRequest, opts ...grpc.CallOption) (*CreateCDCFlowResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_CreateCDCFlow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CreateQRepFlow(ctx context.Context, in *CreateQRepFlowRequest, opts ...grpc.CallOption) (*CreateQRepFlowResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_CreateQRepFlow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetAlertConfigs(ctx context.Context, in *GetAlertConfigsRequest, opts ...grpc.CallOption) (*GetAlertConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetAlertConfigs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) PostAlertConfig(ctx context.Context, in *PostAlertConfigRequest, opts ...grpc.CallOption) (*PostAlertConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_PostAlertConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) DeleteAlertConfig(ctx context.Context, in *DeleteAlertConfigRequest, opts ...grpc.CallOption) (*DeleteAlertConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_DeleteAlertConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetDynamicSettings(ctx context.Context, in *GetDynamicSettingsRequest, opts ...grpc.CallOption) (*GetDynamicSettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetDynamicSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) PostDynamicSetting(ctx context.Context, in *PostDynamicSettingRequest, opts ...grpc.CallOption) (*PostDynamicSettingResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_PostDynamicSetting_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetScripts(ctx context.Context, in *GetScriptsRequest, opts ...grpc.CallOption) (*GetScriptsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetScripts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) PostScript(ctx context.Context, in *PostScriptRequest, opts ...grpc.CallOption) (*PostScriptResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_PostScript_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) DeleteScript(ctx context.Context, in *DeleteScriptRequest, opts ...grpc.CallOption) (*DeleteScriptResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_DeleteScript_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetSchemas(ctx context.Context, in *PostgresPeerActivityInfoRequest, opts ...grpc.CallOption) (*PeerSchemasResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetSchemas_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetPublications(ctx context.Context, in *PostgresPeerActivityInfoRequest, opts ...grpc.CallOption) (*PeerPublicationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetPublications_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetTablesInSchema(ctx context.Context, in *SchemaTablesRequest, opts ...grpc.CallOption) (*SchemaTablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetTablesInSchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetAllTables(ctx context.Context, in *PostgresPeerActivityInfoRequest, opts ...grpc.CallOption) (*AllTablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetAllTables_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetColumns(ctx context.Context, in *TableColumnsRequest, opts ...grpc.CallOption) (*TableColumnsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetColumns_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetColumnsTypeConversion(ctx context.Context, in *ColumnsTypeConversionRequest, opts ...grpc.CallOption) (*ColumnsTypeConversionResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetColumnsTypeConversion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetSlotInfo(ctx context.Context, in *PostgresPeerActivityInfoRequest, opts ...grpc.CallOption) (*PeerSlotResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetSlotInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetSlotLagHistory(ctx context.Context, in *GetSlotLagHistoryRequest, opts ...grpc.CallOption) (*GetSlotLagHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetSlotLagHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetStatInfo(ctx context.Context, in *PostgresPeerActivityInfoRequest, opts ...grpc.CallOption) (*PeerStatResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetStatInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) ListMirrorLogs(ctx context.Context, in *ListMirrorLogsRequest, opts ...grpc.CallOption) (*ListMirrorLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ListMirrorLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) ListMirrors(ctx context.Context, in *ListMirrorsRequest, opts ...grpc.CallOption) (*ListMirrorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ListMirrors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) ListMirrorNames(ctx context.Context, in *ListMirrorNamesRequest, opts ...grpc.CallOption) (*ListMirrorNamesResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ListMirrorNames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) FlowStateChange(ctx context.Context, in *FlowStateChangeRequest, opts ...grpc.CallOption) (*FlowStateChangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_FlowStateChange_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) MirrorStatus(ctx context.Context, in *MirrorStatusRequest, opts ...grpc.CallOption) (*MirrorStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_MirrorStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetCDCBatches(ctx context.Context, in *GetCDCBatchesRequest, opts ...grpc.CallOption) (*GetCDCBatchesResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetCDCBatches_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CDCBatches(ctx context.Context, in *GetCDCBatchesRequest, opts ...grpc.CallOption) (*GetCDCBatchesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCDCBatchesResponse)
	err := c.cc.Invoke(ctx, FlowService_CDCBatches_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CDCGraph(ctx context.Context, in *GraphRequest, opts ...grpc.CallOption) (*GraphResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_CDCGraph_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) InitialLoadSummary(ctx context.Context, in *InitialLoadSummaryRequest, opts ...grpc.CallOption) (*InitialLoadSummaryResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_InitialLoadSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetPeerInfo(ctx context.Context, in *PeerInfoRequest, opts ...grpc.CallOption) (*PeerInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetPeerInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetPeerType(ctx context.Context, in *PeerInfoRequest, opts ...grpc.CallOption) (*PeerTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetPeerType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) ListPeers(ctx context.Context, in *ListPeersRequest, opts ...grpc.CallOption) (*ListPeersResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_ListPeers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetVersion(ctx context.Context, in *PeerDBVersionRequest, opts ...grpc.CallOption) (*PeerDBVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetInstanceInfo(ctx context.Context, in *InstanceInfoRequest, opts ...grpc.CallOption) (*InstanceInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetInstanceInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) Maintenance(ctx context.Context, in *MaintenanceRequest, opts ...grpc.CallOption) (*MaintenanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_Maintenance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetMaintenanceStatus(ctx context.Context, in *MaintenanceStatusRequest, opts ...grpc.CallOption) (*MaintenanceStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetMaintenanceStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) SkipSnapshotWaitFlows(ctx context.Context, in *SkipSnapshotWaitFlowsRequest, opts ...grpc.CallOption) (*SkipSnapshotWaitFlowsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_SkipSnapshotWaitFlows_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CreateOrReplaceFlowTags(ctx context.Context, in *CreateOrReplaceFlowTagsRequest, opts ...grpc.CallOption) (*CreateOrReplaceFlowTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_CreateOrReplaceFlowTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetFlowTags(ctx context.Context, in *GetFlowTagsRequest, opts ...grpc.CallOption) (*GetFlowTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_GetFlowTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) TotalRowsSyncedByMirror(ctx context.Context, in *TotalRowsSyncedByMirrorRequest, opts ...grpc.CallOption) (*TotalRowsSyncedByMirrorResponse, error) {
	...
	err := c.cc.Invoke(ctx, FlowService_TotalRowsSyncedByMirror_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) CancelTableAddition(ctx context.Context, in *CancelTableAdditionInput, opts ...grpc.CallOption) (*CancelTableAdditionOutput, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelTableAdditionOutput)
	err := c.cc.Invoke(ctx, FlowService_CancelTableAddition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *flowServiceClient) GetMirrorRowCounts(ctx context.Context, in *RowCountRequest, opts ...grpc.CallOption) (*RowCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RowCountResponse)
	err := c.cc.Invoke(ctx, FlowService_GetMirrorRowCounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FlowServiceServer interface {
	...
	GetMirrorRowCounts(context.Context, *RowCountRequest) (*RowCountResponse, error)
...
func (UnimplementedFlowServiceServer) ValidatePeer(context.Context, *ValidatePeerRequest) (*ValidatePeerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidatePeer not implemented")
}
func (UnimplementedFlowServiceServer) ValidateCDCMirror(context.Context, *CreateCDCFlowRequest) (*ValidateCDCMirrorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidateCDCMirror not implemented")
}
...
func (UnimplementedFlowServiceServer) GetDynamicSettings(context.Context, *GetDynamicSettingsRequest) (*GetDynamicSettingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDynamicSettings not implemented")
}
func (UnimplementedFlowServiceServer) PostDynamicSetting(context.Context, *PostDynamicSettingRequest) (*PostDynamicSettingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PostDynamicSetting not implemented")
}
func (UnimplementedFlowServiceServer) GetScripts(context.Context, *GetScriptsRequest) (*GetScriptsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetScripts not implemented")
}
func (UnimplementedFlowServiceServer) PostScript(context.Context, *PostScriptRequest) (*PostScriptResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PostScript not implemented")
}
...
func (UnimplementedFlowServiceServer) GetPublications(context.Context, *PostgresPeerActivityInfoRequest) (*PeerPublicationsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPublications not implemented")
}
func (UnimplementedFlowServiceServer) GetTablesInSchema(context.Context, *SchemaTablesRequest) (*SchemaTablesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTablesInSchema not implemented")
}
func (UnimplementedFlowServiceServer) GetAllTables(context.Context, *PostgresPeerActivityInfoRequest) (*AllTablesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllTables not implemented")
}
...
func (UnimplementedFlowServiceServer) GetColumnsTypeConversion(context.Context, *ColumnsTypeConversionRequest) (*ColumnsTypeConversionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetColumnsTypeConversion not implemented")
}
func (UnimplementedFlowServiceServer) GetSlotInfo(context.Context, *PostgresPeerActivityInfoRequest) (*PeerSlotResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSlotInfo not implemented")
}
...
func (UnimplementedFlowServiceServer) InitialLoadSummary(context.Context, *InitialLoadSummaryRequest) (*InitialLoadSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InitialLoadSummary not implemented")
}
...
func (UnimplementedFlowServiceServer) GetPeerType(context.Context, *PeerInfoRequest) (*PeerTypeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPeerType not implemented")
}
...
func (UnimplementedFlowServiceServer) Maintenance(context.Context, *MaintenanceRequest) (*MaintenanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Maintenance not implemented")
}
...
func (UnimplementedFlowServiceServer) SkipSnapshotWaitFlows(context.Context, *SkipSnapshotWaitFlowsRequest) (*SkipSnapshotWaitFlowsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SkipSnapshotWaitFlows not implemented")
}
func (UnimplementedFlowServiceServer) CreateOrReplaceFlowTags(context.Context, *CreateOrReplaceFlowTagsRequest) (*CreateOrReplaceFlowTagsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOrReplaceFlowTags not implemented")
}
func (UnimplementedFlowServiceServer) GetFlowTags(context.Context, *GetFlowTagsRequest) (*GetFlowTagsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFlowTags not implemented")
}
func (UnimplementedFlowServiceServer) TotalRowsSyncedByMirror(context.Context, *TotalRowsSyncedByMirrorRequest) (*TotalRowsSyncedByMirrorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TotalRowsSyncedByMirror not implemented")
}
...
func (UnimplementedFlowServiceServer) GetMirrorRowCounts(context.Context, *RowCountRequest) (*RowCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMirrorRowCounts not implemented")
}
...
func _FlowService_CancelTableAddition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelTableAdditionInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlowServiceServer).CancelTableAddition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FlowService_CancelTableAddition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlowServiceServer).CancelTableAddition(ctx, req.(*CancelTableAdditionInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _FlowService_GetMirrorRowCounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RowCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlowServiceServer).GetMirrorRowCounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FlowService_GetMirrorRowCounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlowServiceServer).GetMirrorRowCounts(ctx, req.(*RowCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FlowService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMirrorRowCounts",
			Handler:    _FlowService_GetMirrorRowCounts_Handler,
		},
	},
