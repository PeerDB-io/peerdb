...
var file_flow_proto_depIdxs = []int32{
	...
	38, // 33: peerdb_flow.QRepPartition.range:type_name -> peerdb_flow.PartitionRange
	41, // 34: peerdb_flow.QRepPartitionBatch.partitions:type_name -> peerdb_flow.QRepPartition
	41, // 35: peerdb_flow.QRepParitionResult.partitions:type_name -> peerdb_flow.QRepPartition
	13, // 36: peerdb_flow.DropFlowInput.flow_connection_configs:type_name -> peerdb_flow.FlowConnectionConfigs
	29, // 37: peerdb_flow.TableSchemaDelta.added_columns:type_name -> peerdb_flow.FieldDescription
	2,  // 38: peerdb_flow.TableSchemaDelta.system:type_name -> peerdb_flow.TypeSystem
	41, // 39: peerdb_flow.QRepFlowState.last_partition:type_name -> peerdb_flow.QRepPartition
	3,  // 40: peerdb_flow.QRepFlowState.current_flow_status:type_name -> peerdb_flow.FlowStatus
	11, // 41: peerdb_flow.CDCFlowConfigUpdate.additional_tables:type_name -> peerdb_flow.TableMapping
	11, // 42: peerdb_flow.CDCFlowConfigUpdate.removed_tables:type_name -> peerdb_flow.TableMapping
	81, // 43: peerdb_flow.CDCFlowConfigUpdate.updated_env:type_name -> peerdb_flow.CDCFlowConfigUpdate.UpdatedEnvEntry
	49, // 44: peerdb_flow.FlowConfigUpdate.cdc_flow_config_update:type_name -> peerdb_flow.CDCFlowConfigUpdate
	50, // 45: peerdb_flow.FlowConfigUpdate.qrep_flow_config_update:type_name -> peerdb_flow.QRepFlowConfigUpdate
	82, // 46: peerdb_flow.SetupFlowOutput.src_table_id_name_mapping:type_name -> peerdb_flow.SetupFlowOutput.SrcTableIdNameMappingEntry
	11, // 47: peerdb_flow.AddTablesToPublicationInput.additional_tables:type_name -> peerdb_flow.TableMapping
	11, // 48: peerdb_flow.RemoveTablesFromPublicationInput.tables_to_remove:type_name -> peerdb_flow.TableMapping
	83, // 49: peerdb_flow.MaintenanceMirror.mirror_created_at:type_name -> google.protobuf.Timestamp
	83, // 50: peerdb_flow.MaintenanceMirror.mirror_updated_at:type_name -> google.protobuf.Timestamp
	63, // 51: peerdb_flow.MaintenanceMirrors.mirrors:type_name -> peerdb_flow.MaintenanceMirror
	84, // 52: peerdb_flow.PeerContextMetadata.type:type_name -> peerdb_peers.DBType
	3,  // 53: peerdb_flow.FlowContextMetadataInput.status:type_name -> peerdb_flow.FlowStatus
	65, // 54: peerdb_flow.FlowContextMetadata.source:type_name -> peerdb_flow.PeerContextMetadata
	65, // 55: peerdb_flow.FlowContextMetadata.destination:type_name -> peerdb_flow.PeerContextMetadata
	3,  // 56: peerdb_flow.FlowContextMetadata.status:type_name -> peerdb_flow.FlowStatus
	7,  // 57: peerdb_flow.AdditionalContextMetadata.operation:type_name -> peerdb_flow.FlowOperation
	22, // 58: peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry.value:type_name -> peerdb_flow.PostgresTableIdentifier
