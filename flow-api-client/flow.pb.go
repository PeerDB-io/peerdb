...
var file_flow_proto_rawDesc = []byte{
	...
	0x79, 0x6e, 0x63, 0x22, 0x55, 0x0a, 0x19, 0x41, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61,
	...
	0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x70, 0x65, 0x65, 0x72, 0x64, 0x62, 0x5f, 0x66, 0x6c, 0x6f,
	0x77, 0x2e, 0x46, 0x6c, 0x6f, 0x77, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x4b, 0x0a, 0x0b, 0x54, 0x61,
...
var file_flow_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_flow_proto_goTypes = []interface{}{
	...
	(*EndMaintenanceFlowInput)(nil),          // 60: peerdb_flow.EndMaintenanceFlowInput
	(*EndMaintenanceFlowOutput)(nil),         // 61: peerdb_flow.EndMaintenanceFlowOutput
	(*MaintenanceMirror)(nil),                // 62: peerdb_flow.MaintenanceMirror
	(*MaintenanceMirrors)(nil),               // 63: peerdb_flow.MaintenanceMirrors
	(*PeerContextMetadata)(nil),              // 64: peerdb_flow.PeerContextMetadata
	(*FlowContextMetadataInput)(nil),         // 65: peerdb_flow.FlowContextMetadataInput
	(*FlowContextMetadata)(nil),              // 66: peerdb_flow.FlowContextMetadata
	(*AdditionalContextMetadata)(nil),        // 67: peerdb_flow.AdditionalContextMetadata
	nil,                                      // 68: peerdb_flow.SetupInput.EnvEntry
	nil,                                      // 69: peerdb_flow.FlowConnectionConfigs.EnvEntry
	nil,                                      // 70: peerdb_flow.CreateTablesFromExistingInput.NewToExistingTableMappingEntry
	nil,                                      // 71: peerdb_flow.SyncFlowOptions.SrcTableIdNameMappingEntry
	nil,                                      // 72: peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry
	nil,                                      // 73: peerdb_flow.SetupReplicationInput.TableNameMappingEntry
	nil,                                      // 74: peerdb_flow.CreateRawTableInput.TableNameMappingEntry
	nil,                                      // 75: peerdb_flow.SetupTableSchemaBatchInput.EnvEntry
	nil,                                      // 76: peerdb_flow.SetupNormalizedTableBatchInput.EnvEntry
	nil,                                      // 77: peerdb_flow.SetupNormalizedTableBatchOutput.TableExistsMappingEntry
	nil,                                      // 78: peerdb_flow.QRepConfig.EnvEntry
	nil,                                      // 79: peerdb_flow.CDCFlowConfigUpdate.UpdatedEnvEntry
	nil,                                      // 80: peerdb_flow.SetupFlowOutput.SrcTableIdNameMappingEntry
	(*timestamppb.Timestamp)(nil),            // 81: google.protobuf.Timestamp
	(DBType)(0),                              // 82: peerdb_peers.DBType
}
var file_flow_proto_depIdxs = []int32{
	...
	68, // 2: peerdb_flow.SetupInput.env:type_name -> peerdb_flow.SetupInput.EnvEntry
	...
	69, // 5: peerdb_flow.FlowConnectionConfigs.env:type_name -> peerdb_flow.FlowConnectionConfigs.EnvEntry
	14, // 6: peerdb_flow.RenameTablesInput.rename_table_options:type_name -> peerdb_flow.RenameTableOption
	70, // 7: peerdb_flow.CreateTablesFromExistingInput.new_to_existing_table_mapping:type_name -> peerdb_flow.CreateTablesFromExistingInput.NewToExistingTableMappingEntry
	71, // 8: peerdb_flow.SyncFlowOptions.src_table_id_name_mapping:type_name -> peerdb_flow.SyncFlowOptions.SrcTableIdNameMappingEntry
	11, // 9: peerdb_flow.SyncFlowOptions.table_mappings:type_name -> peerdb_flow.TableMapping
	72, // 10: peerdb_flow.EnsurePullabilityBatchOutput.table_identifier_mapping:type_name -> peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry
	73, // 11: peerdb_flow.SetupReplicationInput.table_name_mapping:type_name -> peerdb_flow.SetupReplicationInput.TableNameMappingEntry
	74, // 12: peerdb_flow.CreateRawTableInput.table_name_mapping:type_name -> peerdb_flow.CreateRawTableInput.TableNameMappingEntry
	2,  // 13: peerdb_flow.TableSchema.system:type_name -> peerdb_flow.TypeSystem
	29, // 14: peerdb_flow.TableSchema.columns:type_name -> peerdb_flow.FieldDescription
	75, // 15: peerdb_flow.SetupTableSchemaBatchInput.env:type_name -> peerdb_flow.SetupTableSchemaBatchInput.EnvEntry
	2,  // 16: peerdb_flow.SetupTableSchemaBatchInput.system:type_name -> peerdb_flow.TypeSystem
	11, // 17: peerdb_flow.SetupTableSchemaBatchInput.table_mappings:type_name -> peerdb_flow.TableMapping
	76, // 18: peerdb_flow.SetupNormalizedTableBatchInput.env:type_name -> peerdb_flow.SetupNormalizedTableBatchInput.EnvEntry
	11, // 19: peerdb_flow.SetupNormalizedTableBatchInput.table_mappings:type_name -> peerdb_flow.TableMapping
	77, // 20: peerdb_flow.SetupNormalizedTableBatchOutput.table_exists_mapping:type_name -> peerdb_flow.SetupNormalizedTableBatchOutput.TableExistsMappingEntry
	81, // 21: peerdb_flow.TimestampPartitionRange.start:type_name -> google.protobuf.Timestamp
	81, // 22: peerdb_flow.TimestampPartitionRange.end:type_name -> google.protobuf.Timestamp
	36, // 23: peerdb_flow.TIDPartitionRange.start:type_name -> peerdb_flow.TID
	36, // 24: peerdb_flow.TIDPartitionRange.end:type_name -> peerdb_flow.TID
	34, // 25: peerdb_flow.PartitionRange.int_range:type_name -> peerdb_flow.IntPartitionRange
	35, // 26: peerdb_flow.PartitionRange.timestamp_range:type_name -> peerdb_flow.TimestampPartitionRange
	37, // 27: peerdb_flow.PartitionRange.tid_range:type_name -> peerdb_flow.TIDPartitionRange
	1,  // 28: peerdb_flow.QRepWriteMode.write_type:type_name -> peerdb_flow.QRepWriteType
	39, // 29: peerdb_flow.QRepConfig.write_mode:type_name -> peerdb_flow.QRepWriteMode
	2,  // 30: peerdb_flow.QRepConfig.system:type_name -> peerdb_flow.TypeSystem
	78, // 31: peerdb_flow.QRepConfig.env:type_name -> peerdb_flow.QRepConfig.EnvEntry
	38, // 32: peerdb_flow.QRepPartition.range:type_name -> peerdb_flow.PartitionRange
	41, // 33: peerdb_flow.QRepPartitionBatch.partitions:type_name -> peerdb_flow.QRepPartition
	41, // 34: peerdb_flow.QRepParitionResult.partitions:type_name -> peerdb_flow.QRepPartition
	13, // 35: peerdb_flow.DropFlowInput.flow_connection_configs:type_name -> peerdb_flow.FlowConnectionConfigs
	29, // 36: peerdb_flow.TableSchemaDelta.added_columns:type_name -> peerdb_flow.FieldDescription
	2,  // 37: peerdb_flow.TableSchemaDelta.system:type_name -> peerdb_flow.TypeSystem
	41, // 38: peerdb_flow.QRepFlowState.last_partition:type_name -> peerdb_flow.QRepPartition
	3,  // 39: peerdb_flow.QRepFlowState.current_flow_status:type_name -> peerdb_flow.FlowStatus
	11, // 40: peerdb_flow.CDCFlowConfigUpdate.additional_tables:type_name -> peerdb_flow.TableMapping
	11, // 41: peerdb_flow.CDCFlowConfigUpdate.removed_tables:type_name -> peerdb_flow.TableMapping
	79, // 42: peerdb_flow.CDCFlowConfigUpdate.updated_env:type_name -> peerdb_flow.CDCFlowConfigUpdate.UpdatedEnvEntry
	49, // 43: peerdb_flow.FlowConfigUpdate.cdc_flow_config_update:type_name -> peerdb_flow.CDCFlowConfigUpdate
	50, // 44: peerdb_flow.FlowConfigUpdate.qrep_flow_config_update:type_name -> peerdb_flow.QRepFlowConfigUpdate
	80, // 45: peerdb_flow.SetupFlowOutput.src_table_id_name_mapping:type_name -> peerdb_flow.SetupFlowOutput.SrcTableIdNameMappingEntry
	11, // 46: peerdb_flow.AddTablesToPublicationInput.additional_tables:type_name -> peerdb_flow.TableMapping
	11, // 47: peerdb_flow.RemoveTablesFromPublicationInput.tables_to_remove:type_name -> peerdb_flow.TableMapping
	81, // 48: peerdb_flow.MaintenanceMirror.mirror_created_at:type_name -> google.protobuf.Timestamp
	62, // 49: peerdb_flow.MaintenanceMirrors.mirrors:type_name -> peerdb_flow.MaintenanceMirror
	82, // 50: peerdb_flow.PeerContextMetadata.type:type_name -> peerdb_peers.DBType
	3,  // 51: peerdb_flow.FlowContextMetadataInput.status:type_name -> peerdb_flow.FlowStatus
	64, // 52: peerdb_flow.FlowContextMetadata.source:type_name -> peerdb_flow.PeerContextMetadata
	64, // 53: peerdb_flow.FlowContextMetadata.destination:type_name -> peerdb_flow.PeerContextMetadata
	3,  // 54: peerdb_flow.FlowContextMetadata.status:type_name -> peerdb_flow.FlowStatus
	7,  // 55: peerdb_flow.AdditionalContextMetadata.operation:type_name -> peerdb_flow.FlowOperation
	22, // 56: peerdb_flow.EnsurePullabilityBatchOutput.TableIdentifierMappingEntry.value:type_name -> peerdb_flow.PostgresTableIdentifier
